...
//		return false;
//	}
////====       For Generate Data to get Data to input database            ====
//	
...
//	// format("insert into tbbook(id,title,publishDate,author,page,coverImage)
//	// values(%s, '%s', %s, '%s', %s, '%s');",i + 1, title, 2005 + i, author, i +
//	// 600, image));
//	//
//	// }
//	// }
